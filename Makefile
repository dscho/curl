...
ACLOCAL = ${SHELL} /usr/src/MINGW-packages/mingw-w64-curl/src/curl-7.54.0/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /mingw64/bin/ar
AS = as
AUTOCONF = ${SHELL} /usr/src/MINGW-packages/mingw-w64-curl/src/curl-7.54.0/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/MINGW-packages/mingw-w64-curl/src/curl-7.54.0/missing autoheader
AUTOMAKE = ${SHELL} /usr/src/MINGW-packages/mingw-w64-curl/src/curl-7.54.0/missing automake-1.15
AWK = gawk
BLANK_AT_MAKETIME = 
CC = gcc
...
CPP = gcc -E
CPPFLAGS = -IC:/git-sdk-64/mingw64/include -IC:/git-sdk-64/mingw64/include
...
IPV6_ENABLED = 1
LD = C:/git-sdk-64/mingw64/x86_64-w64-mingw32/bin/ld.exe
LDFLAGS = -LC:/git-sdk-64/mingw64/lib -LC:/git-sdk-64/mingw64/lib
LIBCURL_LIBS = -lnghttp2 -lrtmp -lssh2 -lssl -lcrypto -lcrypt32 -lwldap32 -lz -lws2_32
LIBMETALINK_CPPFLAGS = -IC:/git-sdk-64/mingw64/include
LIBMETALINK_LDFLAGS = -LC:/git-sdk-64/mingw64/lib
LIBMETALINK_LIBS = -lmetalink
LIBOBJS = 
LIBS = -lnghttp2 -lrtmp -lssh2 -lssl -lcrypto -lcrypt32 -lwldap32 -lz -lws2_32
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /usr/src/MINGW-packages/mingw-w64-curl/src/curl-7.54.0/missing makeinfo
MANIFEST_TOOL = :
MANOPT = -man
...
STRIP = strip
SUPPORT_FEATURES = SSL IPv6 libz SSPI SPNEGO Kerberos NTLM HTTP2
...
abs_builddir = /usr/src/MINGW-packages/mingw-w64-curl/src/curl-7.54.0
abs_srcdir = /usr/src/MINGW-packages/mingw-w64-curl/src/curl-7.54.0
abs_top_builddir = /usr/src/MINGW-packages/mingw-w64-curl/src/curl-7.54.0
abs_top_srcdir = /usr/src/MINGW-packages/mingw-w64-curl/src/curl-7.54.0
ac_ct_AR = 
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /usr/src/MINGW-packages/mingw-w64-curl/src/curl-7.54.0/install-sh
...
LIB_VTLS_CFILES = vtls/openssl.c vtls/gtls.c vtls/vtls.c vtls/nss.c     \
  ...
  vtls/mbedtls.c vtls/multi.c

LIB_VTLS_HFILES = vtls/openssl.h vtls/vtls.h vtls/gtls.h                \
  vtls/nssg.h vtls/polarssl.h vtls/polarssl_threadlock.h vtls/axtls.h   \
  vtls/cyassl.h vtls/schannel.h vtls/darwinssl.h vtls/gskit.h           \
  vtls/mbedtls.h vtls/multi.h
